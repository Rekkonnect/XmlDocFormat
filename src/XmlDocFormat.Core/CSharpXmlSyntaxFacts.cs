...
public sealed class CSharpXmlSyntaxFacts : BaseXmlSyntaxFacts, ISharedInstance
{
    // Nodes
    ...
    public override RawSyntaxKind XmlTextAttribute => SyntaxKind.XmlTextAttribute;
    ...
    // Tokens
    public override RawSyntaxKind XmlTextLiteralNewLineToken => SyntaxKind.XmlTextLiteralNewLineToken;
    ...
    public override string MultiLineDocumentationPrefix => "/**";
}
